...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./admin/css/admin_new_release.css" />
...
<body>
    ...
    <div class="main">
        ...
        <div class="main_right">
            <div class="path">新闻发布管理&nbsp;>&nbsp;发布新闻</div>
                ...
                <form action="" method="post" onsubmit="javascript:return form_submit();">
                    <table class="table1" width="100%" border="0" cellspacing="1" cellpadding="0">
                          <tr>  
                            ...
                            <td class="td1">
                                <input id="newtitle" name="title" type="text" maxlength="100" size="50"/>
                            </td>
                          </tr>
                          <tr>
                            <td class="td2"><u>Meta Keywords</u><br />
                            Keywords 项出现在页面头部的 Meta 标签中，用于记录关键词，多个关键词用半角逗号 "," 分隔</td>
                            <td class="td2"><textarea name="keywords" rows="3" cols="40"></textarea></td>
                          </tr>
                          <tr>
                            <td class="td1"><u>Meta Description</u><br />
                            Description 项出现在页面头部的 Meta 标签中，用于记录概要描述</td>
                            <td class="td1"><textarea name="descn" rows="3" cols="40"></textarea></td>
                          </tr>
                          <tr>
                            <td class="td2">发&nbsp;布&nbsp;时&nbsp;间<br />
                            	时间的格式必须是YY-MM-DD HH:II:SS后面不能有空格。
                            </td>
                            <td class="td2"><input name="datetime" type="text" maxlength="100" size="50" value="<?php echo $datetime;?>"/></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="td2" colspan="2" align="center" valign="top">
                                <textarea id="container" name="content" style="height:600px;"></textarea>
                            </td>
                          </tr>
                    </table>
                    <table class="table2">
